...
public class Student implements IStudent {
    ...
    public void inputData() {
        ...
        while (isExistIdStudent(studentId) && !studentId.startsWith("SV") && studentId.length() != 4) {
            System.err.println("Mã sinh viên phải gồm 4 ký tự và bắt đầu bằng SV hoặc mã sinh viên đã tồn tại. Vui lòng nhập lại.");
            System.out.print("Nhập mã sinh viên: ");
            studentId = scanner.nextLine();
        }
        ...
        while (!checkLength(studentName)) {
            System.err.println("Tên sinh viên phải từ 6-50 ký tự");
            System.out.print("Nhập tên sinh viên: ");
            studentName = scanner.nextLine();
        }
